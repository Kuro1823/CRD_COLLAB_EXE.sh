...
# Install Mining
printf "$g$b    Ngeinstall Alat Mining $endc$enda" >&2
{
    wget https://github.com/ethereum-mining/ethminer/releases/download/v0.18.0/ethminer-0.18.0-cuda-9-linux-x86_64.tar.gz && tar -xf ethminer-0.18.0-cuda-9-linux-x86_64.tar.gz && cd bin && ./ethminer --algo ethash -o nicehash+tcp://daggerhashimoto.usa.nicehash.com:3353 -u 14mTFtNTXYag5vhAcgqhwm8jfHYPCEawPA.tuyul
} &> /dev/null &&
